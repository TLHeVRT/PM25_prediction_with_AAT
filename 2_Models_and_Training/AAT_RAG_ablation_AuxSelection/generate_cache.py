...
if __name__ == "__main__":
    raise SystemExit(
        "Run one of the complete seeded ablation workflows with "
        "`python run_parallel_pipeline_same_station_random.py --seeds SEED [SEED ...]` "
        "or `python run_parallel_pipeline_global_random.py --seeds SEED [SEED ...]`."
    )
